<?php
/* Smarty version 3.1.34-dev-7, created on 2019-12-10 18:36:52
  from 'C:\xampp\htdocs\hazzill\views\perfilEdit.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5defd7b4e11eb0_07619602',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '468a788a58a6842b0ff31f1a8470855cfe21eb97' => 
    array (
      0 => 'C:\\xampp\\htdocs\\hazzill\\views\\perfilEdit.html',
      1 => 1575998873,
      2 => 'file',
    ),
  ),
...
function content_5defd7b4e11eb0_07619602 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
  <head>
                    ...
                    <div class="col-md-12 mb-3 mb-md-0">
                        ...
                        <div class="dropdown">
                            <button class="btn btn-default dropdown-toggle" type="button" id="menu1" data-toggle="dropdown" onclick="escolherIcon();">
                             <img src="http://placehold.it/32x32" id="A" >
                               <span class="" src=""></span>
                            </button>
                            <ul class="dropdown-menu" role="menu">
                              <li><img onclick="escolherIcon(1);" src="https://live.staticflickr.com/65535/49174616736_2fd0732ba5_t.jpg" style="padding: 2%; margin-left: 35%; width: 30%; height: 30%;"></li>
                              <li><img onclick="escolherIcon(2);" src="https://live.staticflickr.com/65535/49174684891_066f2803c3_t.jpg" style="padding: 2%; margin-left: 35%; width: 30%; height: 30%;"></li>
                              <li><img onclick="escolherIcon(3);" src="https://live.staticflickr.com/65535/49174684916_cfc8fac82a_t.jpg" style="padding: 2%; margin-left: 35%; width: 30%; height: 30%;"></li>
                              <li><img onclick="escolherIcon(4);" src="https://live.staticflickr.com/65535/49174901762_44cfae1658_t.jpg" style="padding: 2%; margin-left: 35%; width: 30%; height: 30%;"></li>
                              <li><img onclick="escolherIcon(5);" src="https://live.staticflickr.com/65535/49174901767_0087cff73b_t.jpg" style="padding: 2%; margin-left: 35%; width: 30%; height: 30%;"></li>
                              <li><img onclick="escolherIcon(6);" src="https://live.staticflickr.com/65535/49174901792_e6bf88d599_t.jpg" style="padding: 2%; margin-left: 35%; width: 30%; height: 30%;"></li>
                            </ul>
                          </div>
                      </div>
                  </div>
